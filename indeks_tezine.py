...
# visina_cm = int(input("Dragi krosinice koliko si visiok(a) (cm)>"))
visina_cm = int(input(r"Dragi krosinice koliko si visok\a (cm)> "))

# masa_kg = int(input(r"Dragi krosinice kolika ti je masa (kg)> "))
masa_kg = float(input(r"Dragi krosinice kolika ti je masa (kg)> "))

print(f"Visina: {visina_cm} cm")
# print(f"Tezina: {masa_kg:.0f} kg")
# print(f"Tezina: {masa_kg:.1f} kg")
print(f"Tezina: {masa_kg:.2f} kg")

visina_m = visina_cm / 100

# bmi_indeks = masa_kg / (visina_m * visina_m)
...
# if bmi_indeks < 18.5:
#     print("Mršav – jedi više proteina!")
# elif bmi_indeks >= 18.5 and bmi_indeks < 25:
#     print("Idealna kondicija – super!")
# elif bmi_indeks >= 25 and bmi_indeks < 30:
#     print("Vanjski – više kardio vježbi.")
# elif bmi_indeks > 30:
#     print("Pretio – vrijeme za promjene!")
